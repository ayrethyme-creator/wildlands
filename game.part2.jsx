...
const PHOTO_ART = {
  /* The second hundred myths (part95). Rendered 2026-09-10 through the
     Scrying Glass pipeline; six were re-rendered after the alpha audit
     caught leaked backgrounds, which is what that audit is for. Until a
     key appears here the species draws its nearest-shaped fallback, so
     adding a line is the whole of switching a sprite on. */
  "abiku": true,
  "adze": true,
  "agropelter": true,
  "akualele": true,
