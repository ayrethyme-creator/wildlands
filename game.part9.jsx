...
Object.assign(ART, {
  ...
  sawfish: rayA({ hide: "#8a8a74", belly: "#e0dcc4", saw: true, iris: "#26221c" }),
  ...
  lionfish: lionfishA({ body: "#f2e2d0", stripeC: "#a83a2a", membC: "#f6ece2", iris: "#c9a43a" }),
  ...
  moray: eelA({ body: "#5c6a3a", belly: "#a8b07a", finC: "#4a5a2e", spots: true, markC: "#e8dcc3", gape: true, thick: true, iris: "#c9a43a" }),
  swordfish: elongA({ body: "#3a4a5c", belly: "#dfe4ea", finC: "#2e3c4a", bill: true, iris: "#26221c" }),
  marlin: elongA({ body: "#2e4a8a", belly: "#dfe4ea", finC: "#24407a", bill: true, sail: true, stripes: true, markC: "#4a6ab5", iris: "#26221c" }),
  sailfish: elongA({ body: "#2a5c9a", belly: "#eef2f4", finC: "#1e4a86", bill: true, sail: true, stripes: true, markC: "#5c8ad4", iris: "#26221c" }),
  anglerfish: anglerA({ body: "#2e2a30", lureC: "#9ae8d4", warts: true, iris: "#e8dcc3" }),
  barracuda: elongA({ body: "#8a949a", belly: "#eef2f4", finC: "#6b757a", stripes: true, markC: "#5c666a", bigEye: true, iris: "#26221c" }),
  grouper: fishA({ body: "#8a6b4a", spots: true, markC: "#e8dcc3", bigEye: true }),
  oarfish: elongA({ body: "#c9cdd4", belly: "#eef0f4", ribbon: true, crestC: "#c94a4a", spots: true, iris: "#26221c" }),
  sunfishmola: molaA({ body: "#9aa4ac", mottle: true, iris: "#26221c" }),
  ...
  axolotl: salA({ skin: "#e8b8c4", belly: "#f6dde4", gills: true, gillC: "#e8607a", finTail: true, iris: "#3a2a2a" }),
  // seahorses
  ...
  harrishawk: rapA({ body: "#4c3a2e", wingC: "#a34a26", head: "#4c3a2e", beakC: "#e8c547", iris: "#6b4a2a" }),
  ...
  // insects & pollinators
  honeybee: beeA({ body: "#e8b03a", bandC: "#3a2f22", fuzzC: "#c9964a", head: "#3a2f22", pollen: true, sting: true, iris: "#1a1614" }),
  bumblebee: beeA({ body: "#e8c93a", bandC: "#2e2a22", fuzzC: "#f2d96a", head: "#2e2a22", pollen: true, sting: true, iris: "#1a1614" }),
  orchidbee: beeA({ body: "#3aa87a", bandC: "#1e5c44", fuzzC: "#4ac99a", head: "#1e5c44", pollen: true, pollenC: "#e8c547", iris: "#1a1614" }),
  masonbee: beeA({ body: "#4a6a7a", bandC: "#2a3a44", fuzzC: "#6b8a9a", head: "#2a3a44", iris: "#1a1614" }),
  ...
  dragonfly: odonA({ body: "#3a8a9a", head: "#4a9aaa", wingSpot: true, iris: "#2e6a7a" }),
  damselfly: odonA({ body: "#4a7ac9", head: "#5a8ad9", damsel: true, iris: "#2e5a9a" }),
  mantis: mantidA({ body: "#6b9a4a", head: "#7aa855", wings: true, wingC: "#8abb63", iris: "#e8dcc3" }),
  ...
  goliathbeetle: beetleA({ body: "#2e2a22", elytra: "#e8e2d4", horn: true, hornC: "#3a342b", spots: true, markC: "#3a342b", iris: "#1a1614" }),
  jewelbeetle: beetleA({ body: "#1e5c44", elytra: "#2ea87a", iris: "#1a1614" }),
  cicada: cicadaA({ body: "#3a4a2e", wingC: "#dfe8ee", veinC: "#4a5c3a", iris: "#8a3a2a" }),
  ...
  firesalamander: salA({ skin: "#2e2a26", belly: "#4a423a", spots: true, markC: "#e8c22a", iris: "#26221c" }),
  newt: salA({ skin: "#4a6a3a", belly: "#e8a53a", spots: true, markC: "#2e3a26", warts: true, finTail: true, iris: "#26221c" }),
  hellbender: salA({ skin: "#6b5a44", belly: "#a89478", warts: true, spots: true, markC: "#4a3c2a", finTail: true, iris: "#26221c" }),
  olm: salA({ skin: "#f2e2d8", belly: "#f8eee6", gills: true, gillC: "#e8607a", finTail: true, iris: "#e0d4c8" }),
});
...
Object.assign(DEX, {
  ...
  sailfish: A("Sailfish", "sailfish", ["Aquatic", "Swift"], B(52, 64, 40, 90), MV.swi, 0.2),
  ...
  harrishawk: A("Harris's Hawk", "harrishawk", ["Aerial", "Predator"], B(46, 56, 40, 70), MV.aer, 0.3),
