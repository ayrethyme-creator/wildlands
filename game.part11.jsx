...
// what actually lives in the water of each biome
const WC = {
  meadow: [["koi", 10], ["goldfish", 9], ["duck", 10], ["mandarinduck", 8], ["goose", 8], ["swan", 8], ["newt", 10], ["dragonfly", 9], ["damselfly", 9], ["otter", 8], ["mink", 7], ["kingfisher", 8], ["heron", 7], ["turtle", 8], ["frog", 9], ["tadpole", 6]],
  wetland: [["otter", 11], ["giantotter", 7], ["mink", 8], ["capybara", 8], ["platypus", 6], ["turtle", 10], ["newt", 9], ["hellbender", 6], ["goliathfrog", 7], ["glassfrog", 7], ["redeyedtreefrog", 7], ["koi", 8], ["goldfish", 7], ["duck", 9], ["goose", 8], ["swan", 8], ["loon", 7], ["mandarinduck", 8], ["heron", 9], ["kingfisher", 9], ["pelican", 6], ["spoonbill", 6], ["ibis", 6], ["alligator", 5], ["caiman", 5], ["gharial", 4], ["basilisk", 7], ["sitatunga", 6], ["pygmyhippo", 4], ["damselfly", 9], ["dragonfly", 9], ["frog", 9], ["tadpole", 7]],
  jungle: [["greenanaconda", 5], ["caiman", 6], ["gharial", 5], ["basilisk", 8], ["goliathfrog", 8], ["glassfrog", 9], ["redeyedtreefrog", 9], ["amazonriverdolphin", 4], ["giantotter", 6], ["capybara", 8], ["tapir", 6], ["turtle", 8], ["hellbender", 6], ["newt", 8], ["proboscis", 5], ["damselfly", 9], ["dragonfly", 9], ["kingfisher", 8], ["hoatzin", 6], ["frog", 9], ["tadpole", 7]],
  desert: [["turtle", 9], ["newt", 8], ["frog", 9], ["tadpole", 7], ["duck", 7], ["koi", 6], ["goldfish", 6], ["basilisk", 7], ["heron", 6], ["dragonfly", 9], ["damselfly", 8], ["tomatofrog", 6], ["kingfisher", 6]],
  savanna: [["pygmyhippo", 6], ["gharial", 5], ["alligator", 5], ["caiman", 5], ["turtle", 9], ["sitatunga", 7], ["capybara", 7], ["flamingo", 9], ["heron", 8], ["stork", 8], ["pelican", 7], ["ibis", 8], ["spoonbill", 7], ["shoebill", 4], ["kingfisher", 8], ["goliathfrog", 6], ["dragonfly", 9], ["frog", 8], ["tadpole", 6]],
  alpine: [["otter", 8], ["mink", 7], ["newt", 8], ["olm", 5], ["hellbender", 6], ["loon", 7], ["swan", 7], ["duck", 8], ["goose", 8], ["harlequin", 0], ["koi", 6], ["firesalamander", 7], ["dragonfly", 7], ["damselfly", 7], ["frog", 8], ["tadpole", 6], ["kingfisher", 6]],
  volcanic: [["marineiguana", 8], ["greenseaturtle", 7], ["seal", 8], ["penguin", 7], ["puffin", 6], ["moray", 6], ["octopus", 6], ["hermitcrab", 8], ["fiddlercrab", 8], ["coconutcrab", 5], ["turtle", 8], ["stingray", 6], ["reefshark", 5], ["clownfish", 7], ["parrotfish", 6], ["pufferfish", 6], ["firesalamander", 6]],
  grove: [["otter", 10], ["mink", 8], ["beaver", 9], ["newt", 9], ["firesalamander", 8], ["hellbender", 6], ["koi", 7], ["goldfish", 6], ["duck", 8], ["goose", 7], ["swan", 7], ["loon", 7], ["mandarinduck", 7], ["platypus", 5], ["turtle", 8], ["kingfisher", 8], ["heron", 7], ["giantotter", 5], ["dragonfly", 8], ["damselfly", 8], ["frog", 8], ["tadpole", 6]],
};
Object.keys(WC).forEach((k) => { WC[k] = WC[k].filter(([sp]) => DEX[sp]); });
const N = {
...
const mkSeg = (k, n, lvl, biome, seed) => ({ k, n, lvl, lvlWater: lvl, pool: segPool(C[biome], seed, 14), poolN: segPool(N[biome], seed, 8), poolWater: segPool(WC[biome], seed, 9) });
const ROADS = [
