...
mnote("selkie", "Carnivore — fish, as a seal does", "Orkney, Shetland and Ireland",
  "A seal that comes ashore, sheds its skin and is a person underneath, and if you hide the skin it cannot go back. Almost every version is about a man who does exactly that and a wife who searches the house for years. The Northern Isles told it about grey seals, which haul out on the same rocks for decades and have very human-sounding voices, and whose eyes are large and forward-facing and dark. It is a story about somebody who stayed because they could not leave.");
mnote("whitehart", "Herbivore — browse, if it eats at all", "Britain and Arthurian romance",
  "A white stag that appears at the edge of a hunt and leads whoever follows it out of the world they knew. It is a summons rather than an animal: in the romances it turns up when a quest is about to begin, and in older Celtic story it marks the boundary of the Otherworld. Real white deer exist — leucistic, not albino, with dark eyes — and they are rare enough that medieval sightings were recorded as events. Richard II wore one as his badge.");
