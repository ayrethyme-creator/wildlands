...
const INFO = {
  ...
  ayeaye: { d: "Insectivore — grubs, dug out with one long finger", h: "Rainforest of Madagascar", s: "EN", f: "It taps a branch, listens for the hollow, gnaws a hole and hooks the grub out with a skeletal middle finger. It is called echolocation and it is not: fill the cavity with foam and the aye-aye still finds it, so it is reading the wood rather than an echo. Locals have long killed it on sight as an omen." },
