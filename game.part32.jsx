...
n32("osprey", "Piscivore — fish, exclusively", "Every continent except Antarctica", "LC",
  "Its outer toe reverses — a trick it shares only with the owls and two fish eagles — so it can carry a fish with two toes in front and two behind — and it always carries it head-first, because a fish held sideways costs more to fly with. Its nostrils close when it hits the water. It eats almost nothing but live fish, worldwide, everywhere, which is nearly unique among birds of prey.");
...
n32("harrishawk", "Carnivore — jackrabbits, ground squirrels, quail", "Desert scrub, southwestern US to South America", "LC",
  "Almost alone among raptors, it hunts in a team. A family group of up to six works a jackrabbit together — some flush it from cover while others wait to cut it off, and they take turns going into the thorns. They also stack: birds stand on each other's backs on a cactus to get a vantage point. That co-operation is why falconers favour them, being the rare bird of prey that treats a human as part of the group rather than a rival.");
...
n32("sailfish", "Carnivore — sardines, anchovies, squid", "Tropical and subtropical oceans", "LC",
  "The sail is nearly as tall as the fish is deep, and it stays folded into a groove along the back while swimming — it goes up to herd bait. Sailfish hunt in groups, circling a shoal into a tight ball and taking turns to slash through it with the bill, and they flush a vivid barred blue while doing it. The often-quoted 110km/h comes from one 1940s reel test and is almost certainly too high, but nobody disputes they are among the fastest.");
