...
Object.assign(ART, {
  ...
  pig: suidA({ hide: "#e8a8a8", snoutC: "#f4c0c0", iris: "#5c3a2a" }),
  potbellypig: suidA({ hide: "#2e2a26", snoutC: "#5c5348", spots: true, markC: "#d9c9b8", iris: "#3a2a18" }),
  cow: bovA({ coat: "#f4f0e6", patches: true, markC: "#2e2a26", horns: true, hornC: "#e8dcc3", muzzle: "#e8b0a8", tuftC: "#2e2a26", iris: "#3a2a18" }),
