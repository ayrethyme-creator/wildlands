...
// caught off a reef. Thirty-three species, chosen to bring the Field Guide to
// an even 1000.

// ---- freshwater tank sprites ----
Object.assign(ART, {
  neontetra: fishA({ body: "#2a7ad9", finC: "#e8384a", bands: true, markC: "#e8384a" }),
  cardinaltetra: fishA({ body: "#c9384a", finC: "#2a7ad9", bands: true, markC: "#2a7ad9" }),
  ...
  pearldanio: fishA({ body: "#e0c9d9", finC: "#a878a0", spots: true, markC: "#a878a0" }),
  ...
  commonpleco: fishA({ body: "#4a4038", finC: "#26221c", spots: true, markC: "#8a7a68" }),
  betta: fishA({ body: "#c9294a", finC: "#8a1a3a", sail: true }),
  guppy: fishA({ body: "#e8a53a", finC: "#c9384a", spots: true, markC: "#c9384a" }),
  mollyfish: fishA({ body: "#26221c", finC: "#3c3c40" }),
  platyfish: fishA({ body: "#e8683a", finC: "#c9502a" }),
  swordtailfish: fishA({ body: "#3a8a5c", finC: "#26221c" }),
  ...
  clarkiiclownfish: fishA({ body: "#8a4a2a", finC: "#26221c", stripes: true, markC: "#f8f4ea" }),
  bluetang: fishA({ body: "#2a6ad9", finC: "#26221c", sail: true }),
  yellowtang: fishA({ body: "#f2e83a", finC: "#c9b82a", sail: true }),
  royalgramma: fishA({ body: "#8e44ad", finC: "#f2c94a" }),
  coralbeautyangelfish: fishA({ body: "#8e44ad", finC: "#e8683a", bands: true, markC: "#e8683a" }),
  ...
  neondottyback: fishA({ body: "#8e2a8e", finC: "#6b1f6b" }),
  bicolorblenny: fishA({ body: "#2a7ad9", finC: "#f2e83a", bigEye: true }),
...
Object.assign(DEX, {
  ...
  cardinaltetra: P("Cardinal Tetra", "cardinaltetra", ["Aquatic", "Swift"], B(16, 20, 16, 60), MV.aqua, 0.62, "pet"),
  ...
  pearldanio: P("Pearl Danio", "pearldanio", ["Aquatic", "Swift"], B(16, 20, 16, 62), MV.aqua, 0.62, "pet"),
  ...
  commonpleco: P("Common Pleco", "commonpleco", ["Aquatic", "Armor"], B(38, 30, 44, 20), MV.aqua, 0.46, "pet"),
  ...
  mollyfish: P("Molly", "mollyfish", ["Aquatic", "Swift"], B(18, 20, 18, 56), MV.aqua, 0.62, "pet"),
  platyfish: P("Platy", "platyfish", ["Aquatic", "Swift"], B(16, 20, 16, 58), MV.aqua, 0.64, "pet"),
  swordtailfish: P("Swordtail", "swordtailfish", ["Aquatic", "Swift"], B(18, 22, 18, 58), MV.aqua, 0.6, "pet"),
  ...
  clarkiiclownfish: P("Clark's Clownfish", "clarkiiclownfish", ["Aquatic", "Swift"], B(26, 28, 24, 48), MV.aqua, 0.5, "pet"),
  bluetang: P("Blue Tang", "bluetang", ["Aquatic", "Swift"], B(28, 30, 26, 52), MV.aqua, 0.36, "pet"),
  yellowtang: P("Yellow Tang", "yellowtang", ["Aquatic", "Swift"], B(26, 28, 26, 54), MV.aqua, 0.4, "pet"),
  royalgramma: P("Royal Gramma", "royalgramma", ["Aquatic", "Swift"], B(20, 24, 20, 54), MV.aqua, 0.48, "pet"),
  coralbeautyangelfish: P("Coral Beauty Angelfish", "coralbeautyangelfish", ["Aquatic", "Swift"], B(26, 28, 26, 50), MV.aqua, 0.46, "pet"),
  ...
  neondottyback: P("Neon Dottyback", "neondottyback", ["Aquatic", "Predator"], B(20, 28, 18, 52), MV.aqua, 0.46, "pet"),
  bicolorblenny: P("Bicolor Blenny", "bicolorblenny", ["Aquatic", "Swift"], B(18, 20, 18, 48), MV.aqua, 0.52, "pet"),
...
const AQUA_FRESH = ["neontetra", "cardinaltetra", "blackskirttetra", "zebradanio", "pearldanio", "corydoras",
  "bristlenosepleco", "commonpleco", "betta", "guppy", "mollyfish", "platyfish", "swordtailfish",
  "discusfish", "oscarcichlid", "fancygoldfish", "dwarfgourami"];
const AQUA_SALT = ["perculaclownfish", "clarkiiclownfish", "bluetang", "yellowtang", "royalgramma",
  "coralbeautyangelfish", "flameangelfish", "copperbandbutterfly", "bluegreenchromis", "firefishgoby",
  "sixlinewrasse", "neondottyback", "bicolorblenny", "picassotriggerfish", "porcupinepufferfish",
  "banggaicardinalfish"];
...
Object.assign(INFO, {
  ...
  cardinaltetra: { d: "Omnivore — small invertebrates, algae, flake food", h: "Domestic worldwide, from the Rio Negro, Brazil", s: "DOM",
    f: "Almost identical to the neon tetra except its red runs the full length of the body instead of stopping at the middle. Most of the trade is still wild-caught rather than farmed, and it is one of the rare aquarium fish where that is good news — the harvest gives the flooded forest a cash value alive, which is a real argument against clearing it." },
  ...
  pearldanio: { d: "Omnivore — insects, algae, flake food", h: "Domestic worldwide, from Myanmar", s: "DOM",
    f: "The zebra danio's quieter cousin, with an iridescent pinkish sheen instead of stripes, and the same restless mid-water schooling habit. It was one of the first danios in the aquarium trade, decades before its striped relative became a lab animal." },
  ...
  commonpleco: { d: "Herbivore — algae, biofilm, and eventually plants and driftwood", h: "Domestic worldwide, from the Amazon basin", s: "DOM",
    f: "Sold as a thumb-sized algae eater and capable of reaching sixty centimetres in the right tank, which is most of why it is the classic fish outgrown and abandoned — and in warm places like Florida's canals, released ones have gone properly wild. The one at the pet shop is a juvenile no matter how big the tank looks." },
  ...
  mollyfish: { d: "Omnivore — algae, insect larvae, flake food", h: "Domestic worldwide, from Central America and the Gulf coast", s: "DOM",
    f: "One of the few aquarium fish equally at home in fresh, brackish, or full seawater, which is unusual enough that keepers sometimes add aquarium salt to a molly's tank on purpose. Like the guppy it is a livebearer, and the classic solid-black form is a selectively bred colour, not the wild one." },
  ...
  swordtailfish: { d: "Omnivore — algae, insect larvae, flake food", h: "Domestic worldwide, from Mexico and Central America", s: "DOM",
    f: "Named for the sword-like extension on a male's tail fin, used to impress females rather than to fight. It is a livebearer that occasionally does something stranger than its cousins: an older female can spontaneously develop male colouring, behaviour, and a sword of her own." },
  ...
  clarkiiclownfish: { d: "Omnivore — algae, zooplankton", h: "Domestic worldwide, from the Indo-Pacific", s: "DOM",
    f: "The least fussy anemonefish about its landlord — where a percula clownfish needs one of a couple of anemone species, this one will happily settle into a dozen different kinds, which is most of why it is the most widely distributed clownfish on the reef." },
  ...
  yellowtang: { d: "Herbivore — algae", h: "Domestic worldwide, from Pacific reefs, especially Hawaii", s: "DOM",
    f: "Blazing yellow by day and almost white with a faint grey blotch by night — it pales for sleep and colours back up at dawn, a nightly change dramatic enough that new keepers sometimes panic and think it has died in the tank." },
  ...
  coralbeautyangelfish: { d: "Herbivore — algae, sponges", h: "Domestic worldwide, from Indo-Pacific reefs", s: "DOM",
    f: "One of the hardiest and most affordable of the true marine angelfish, and usually the first one recommended to somebody setting up their first reef tank. Wild colour varies by depth and region, from deep purple to nearly orange, long before any breeder gets involved." },
  ...
  neondottyback: { d: "Carnivore — small invertebrates, small fish", h: "Domestic worldwide, from Indo-Pacific reefs", s: "DOM",
    f: "Almost the same shade of purple as the royal gramma and often confused with it at a glance, despite the two being unrelated — a case of two reef fish converging on the same warning colours by coincidence rather than descent. Far more aggressive than its lookalike, and not to be trusted with anything smaller." },
  bicolorblenny: { d: "Herbivore — algae", h: "Domestic worldwide, from Indo-Pacific reefs", s: "DOM",
    f: "Blue-fronted and yellow-tailed, and kept as much for a job as for looks: it grazes nuisance algae off rock and glass all day, perching on a ledge between passes rather than swimming constantly like most reef fish." },
